...
/*!*********************************************!*\
  !*** ./src/s-exp/operators/core/core.fn.ts ***!
  \*********************************************/
/*! exports provided: $car, $$car, $cdr, $$cdr, $cons, $$cons, $first, $$first, $second, $$second, $last, $$last, $rest, $$rest, $firstAndSecond, $$firstAndSecond, $atom, $$atom, $eq, $$eq, $notEq, $$notEq, $list, $$list, $__scope, $__globalScope, $__capture, $__lambda, $__defun, $__refun, $apply, $$apply, $__call, $__try, $raise, $$raise, $__if, $__ifNull, $__cond, $__while, $__doWhile, $__until, $__doUntil, $__repeat, $__for, $pipe, $$pipe, $__get, $__let, $__set, $boolean, $$boolean, $not, $$not, $__and, $$__and, $__or, $$__or, $ambiguousEq, $$ambiguousEq, $ambiguousNotEq, $$ambiguousNotEq, $lt, $$lt, $le, $$le, $gt, $$gt, $ge, $$ge, $isList, $$isList, $isString, $$isString, $isNumber, $$isNumber, $isNaN, $$isNaN, $isFinite, $$isFinite, $isInteger, $$isInteger, $toString, $$toString, $toNumber, $$toNumber, $__toObject, $objectAssign, $$objectAssign, $jsonStringify, $$jsonStringify, $jsonParse, $$jsonParse, $consoleLog, $$consoleLog, $consoleError, $$consoleError */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const $__capture = (state, name) => (...args) => {
  ...
  //  -> S expr  : exprN
  Object(_errors__WEBPACK_IMPORTED_MODULE_2__["checkParamsLength"])('$__capture', args, 1);
...
const $__refun = (state, name) => (...args) => {
  ...
  //  -> S expr  : fn
  Object(_errors__WEBPACK_IMPORTED_MODULE_2__["checkParamsLength"])('$__refun', args, 1, 1);
  const car = $$first(...args);
