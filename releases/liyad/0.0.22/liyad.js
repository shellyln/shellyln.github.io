...
/*!*******************************!*\
  !*** ./src/s-exp/evaluate.ts ***!
  \*******************************/
/*! exports provided: toNumber, resolveSplice, resolveMacro, resolveFunctionSymbol, resolveValueSymbolScope, resolveValueSymbol, collectCapturedVariables, getCapturedScopes, installScope, uninstallScope, getScope, getGlobalScope, optimizeTailCall, evaluate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!*********************************************!*\
  !*** ./src/s-exp/operators/core/core.fn.ts ***!
  \*********************************************/
/*! exports provided: $car, $$car, $cdr, $$cdr, $cons, $$cons, $first, $$first, $second, $$second, $last, $$last, $rest, $$rest, $firstAndSecond, $$firstAndSecond, $atom, $$atom, $eq, $$eq, $notEq, $$notEq, $list, $$list, $__scope, $__globalScope, $__capture, $__lambda, $comp$__lambda, $__defun, $comp$__defun, $__refun, $apply, $$apply, $__call, $__try, $raise, $$raise, $__if, $__ifNull, $__cond, $__while, $__doWhile, $__until, $__doUntil, $__repeat, $__for, $pipe, $$pipe, $__get, $__let, $__set, $boolean, $$boolean, $not, $$not, $__and, $$__and, $__or, $$__or, $ambiguousEq, $$ambiguousEq, $ambiguousNotEq, $$ambiguousNotEq, $lt, $$lt, $le, $$le, $gt, $$gt, $ge, $$ge, $gensym, $isSymbol, $$isSymbol, $isList, $$isList, $isString, $$isString, $isNumber, $$isNumber, $isNaN, $$isNaN, $isFinite, $$isFinite, $isInteger, $$isInteger, $toString, $$toString, $toNumber, $$toNumber, $__toObject, $objectAssign, $$objectAssign, $jsonStringify, $$jsonStringify, $jsonParse, $$jsonParse, $now, $$now, $datetimeFromIso, $$datetimeFromIso, $datetime, $$datetime, $datetimeLc, $$datetimeLc, $datetimeToIsoString, $$datetimeToIsoString, $datetimeToComponents, $$datetimeToComponents, $datetimeToComponentsLc, $$datetimeToComponentsLc, $match, $$match, $consoleLog, $$consoleLog, $consoleError, $$consoleError, $consoleTrace, $$consoleTrace, $consoleTime, $$consoleTime, $consoleTimeEnd, $$consoleTimeEnd, $consoleTimeLog, $$consoleTimeLog */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
      ...
      case "`":
        {
          getChar(state);
          skipWhitespaces(state);
          return (ch === "'" ? _types__WEBPACK_IMPORTED_MODULE_0__["quote"] : _types__WEBPACK_IMPORTED_MODULE_0__["wrapByUnquote"])(state, parseOneToken(state));
        }
      ...
      case "`":
        {
          ...
          for (;;) {
            ...
            if (typeof t === 'object' && Object.prototype.hasOwnProperty.call(t, 'comment')) {
              ...
              r.push((ch === "'" ? _types__WEBPACK_IMPORTED_MODULE_0__["quote"] : _types__WEBPACK_IMPORTED_MODULE_0__["wrapByUnquote"])(state, t));
              break;
            }
          }
...
/*!****************************!*\
  !*** ./src/s-exp/types.ts ***!
  \****************************/
/*! exports provided: quote, isQuoted, wrapByUnquote, isUnquoted, spread, isSymbol, FatalError, MaxEvaluationCountError, ScriptTerminationError */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
