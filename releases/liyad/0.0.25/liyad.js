...
function stripQuote(state, tok) {
  if (!(Array.isArray(tok) && Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(tok[0], state.config.reservedNames.quote))) {
...
function registerOperators(state, ctx) {
  ...
  ops.set('$__repeat', function (r, args) {
    ...
    if (!Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(args[0])) {
    ...
    makeScope(() => {
      for (const x of Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["stripQuote"])(state, r[3])) {
        ...
        if (Array.isArray(x)) {
          ...
          if (!Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(x[0])) {
          ...
          if (!Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(x)) {
  ...
  ops.set('$__get', function (r, args) {
    ...
    const name = Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(quoted) ? quoted.symbol : typeof quoted === 'string' ? quoted : null;
    ...
    compFnBody += `((${vName})${r.slice(2).map((x, idx, arr) => `[${Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(arr[idx]) ? regToVars(arr[idx].symbol) : compileToken(arr, idx)}]`).join('')})`;
    return compFnBody;
  });
  ...
  ops.set('$__set', function (r, args) {
    ...
    const quoted = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["stripQuote"])(state, r[1]);
    const name = Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(quoted) ? quoted.symbol : typeof quoted === 'string' ? quoted : Array.isArray(quoted) ? Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(quoted[0]) ? quoted[0].symbol : typeof quoted[0] === 'string' ? quoted[0] : null : null;
    ...
    compFnBody += `((${vName})${(Array.isArray(quoted) ? quoted.slice(1) : []).map((x, idx, arr) => `[${Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(arr[idx]) ? regToVars(arr[idx].symbol) : compileToken(arr, idx)}]`).join('')}=${compileToken(r, 2)})`;
    return compFnBody;
  });
...
function compileCore(state, formalArgs, lastIsSpread, fnBody, _$_vars) {
  ...
  function compileValue(b) {
    ...
    if (b === null) {
      ...
      case 'object':
        if (Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(b)) {
          const sym = b;
  ...
  function compileToken(body, i) {
    ...
    if (Array.isArray(b)) {
      if (0 < b.length) {
        ...
        if (Array.isArray(r)) {
          if (0 < r.length) {
            if (Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(r[0])) {
              const sym = r[0];
...
function resolveUnquote(state, r) {
  for (let i = 0; i < r.length; i++) {
    const symUnquote = Array.isArray(r[i]) && Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(r[i][0], state.config.reservedNames.unquote);

    if (symUnquote) {
      r = r.slice(0, i).concat([evaluate(state, r[i][1])], r.slice(i + 1));
    }

    const symSplice = Array.isArray(r[i]) && Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(r[i][0], state.config.reservedNames.splice);

    if (symSplice) {
      const x = r[i][1];

      if (Array.isArray(x) && Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(x[0], state.config.reservedNames.unquote)) {
        r = r.slice(0, i).concat([{
          symbol: state.config.reservedNames.splice
        }, evaluate(state, x[1])], r.slice(i + 1));
      }
    }
  }
...
/*!*********************************************!*\
  !*** ./src/s-exp/operators/core/core.fn.ts ***!
  \*********************************************/
/*! exports provided: $car, $$car, $cdr, $$cdr, $cons, $$cons, $first, $$first, $second, $$second, $last, $$last, $rest, $$rest, $firstAndSecond, $$firstAndSecond, $atom, $$atom, $eq, $$eq, $notEq, $$notEq, $list, $$list, $__scope, $__globalScope, $__capture, $__lambda, $comp$__lambda, $__defun, $comp$__defun, $__refun, $__defmacro, $apply, $$apply, $__call, $__try, $raise, $$raise, $__if, $__ifNull, $__cond, $__while, $__doWhile, $__until, $__doUntil, $__repeat, $__for, $pipe, $$pipe, $__get, $__let, $__set, $boolean, $$boolean, $not, $$not, $__and, $$__and, $__or, $$__or, $ambiguousEq, $$ambiguousEq, $ambiguousNotEq, $$ambiguousNotEq, $lt, $$lt, $le, $$le, $gt, $$gt, $ge, $$ge, $gensym, $isSymbol, $$isSymbol, $isList, $$isList, $isString, $$isString, $isNumber, $$isNumber, $isNaN, $$isNaN, $isFinite, $$isFinite, $isInteger, $$isInteger, $toString, $$toString, $toNumber, $$toNumber, $__toObject, $objectAssign, $$objectAssign, $jsonStringify, $$jsonStringify, $jsonParse, $$jsonParse, $now, $$now, $datetimeFromIso, $$datetimeFromIso, $datetime, $$datetime, $datetimeLc, $$datetimeLc, $datetimeToIsoString, $$datetimeToIsoString, $datetimeToComponents, $$datetimeToComponents, $datetimeToComponentsLc, $$datetimeToComponentsLc, $match, $$match, $consoleLog, $$consoleLog, $consoleError, $$consoleError, $consoleTrace, $$consoleTrace, $consoleTime, $$consoleTime, $consoleTimeEnd, $$consoleTimeEnd, $consoleTimeLog, $$consoleTimeLog */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "$$ge", function() { return $$ge; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "$gensym", function() { return $gensym; });
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../types */ "./src/s-exp/types.ts");
/* harmony import */ var _evaluate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../evaluate */ "./src/s-exp/evaluate.ts");
/* harmony import */ var _compile__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../compile */ "./src/s-exp/compile.ts");
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../errors */ "./src/s-exp/errors.ts");
// Copyright (c) 2018, Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
...
const $car = (state, name) => (...args) => {
  ...
  //  -> S expr  : first
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$car', args, 1, 1);
...
const $cdr = (state, name) => (...args) => {
  ...
  //  -> S expr  : (second ... last)
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$cdr', args, 1, 1);
  const car = $$first(...args);
...
const $cons = (state, name) => (...args) => {
  ...
  //  -> S expr  : arg1.arg2
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$cons', args, 2, 2);
  let {
    car,
    cdr
  } = $$firstAndSecond(...args);
...
const $atom = (state, name) => (...args) => {
  ...
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$atom', args, 1, 1);
  const car = $$first(...args);
...
const $eq = (state, name) => (...args) => {
  ...
  //  -> (if arg1 === arg2)  S expr  : true
  //  -> (else)              S expr  : false
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$eq', args, 2, 2);
  const {
    car,
    cdr
  } = $$firstAndSecond(...args);
...
const $notEq = (state, name) => (...args) => {
  ...
  //  -> (if arg1 !== arg2)  S expr  : true
  //  -> (else)              S expr  : false
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$notEq', args, 2, 2);
  const {
    car,
    cdr
  } = $$firstAndSecond(...args);
...
const $__scope = (state, name, capturedScopes) => (...args) => {
  ...
  //  -> (if returnMultiple)  S expr  : [expr1 ... exprN]
  //  -> (else)               S expr  : exprN
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__scope', args, 3);
  ...
  Object(_evaluate__WEBPACK_IMPORTED_MODULE_1__["installScope"])(state, scope, isBlockLocal, capturedScopes);
...
const $__globalScope = (state, name) => (...args) => {
  ...
  //  -> (if returnMultiple)  S expr  : [expr1 ... exprN]
  //  -> (else)               S expr  : exprN
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__globalScope', args, 1);
...
const $__capture = (state, name) => (...args) => {
  ...
  //  -> S expr  : exprN
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__capture', args, 1);
  ...
  let r = null;
  const capturedScopes = Object(_evaluate__WEBPACK_IMPORTED_MODULE_1__["collectCapturedVariables"])(state, formalArgs);
  Object(_evaluate__WEBPACK_IMPORTED_MODULE_1__["installScope"])(state, {}, true, capturedScopes);
...
const $__lambda = (state, name) => (...args) => {
  // S expression: ($__lambda '(sym1 ... symN) 'expr1 ... 'exprN)
  //  -> S expr  : fn
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__lambda', args, 2);
  const formalArgs = args[0];
  ...
  const fn = (...actualArgs) => {
    ...
    return $__scope(state, name, capturedScopes)(false, false, [[state.config.reservedNames.self, fn], ...formalArgs.map((x, index) => [x.symbol, Object(_types__WEBPACK_IMPORTED_MODULE_0__["quote"])(state, lastIsSpread && index === formalArgs.length - 1 ? actualArgs.slice(index) : actualArgs[index])])], ...fnBody);
  };
...
const $comp$__lambda = (state, name) => (...args) => {
  ...
  return Object(_compile__WEBPACK_IMPORTED_MODULE_2__["compileLambda"])(state, formalArgs, lastIsSpread, fnBody);
}; // tslint:disable-next-line:variable-name

const $__defun = (state, name) => (...args) => {
  // S expression: ($__defun 'name '(sym1 ... symN) 'expr ... 'expr)
  //  -> S expr  : fn
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__defun', args, 3);
  const car = $$first(...args);
...
const $__refun = (state, name) => (...args) => {
  ...
  //  -> S expr  : fn
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__refun', args, 1, 1);
  const car = $$first(...args);
...
const $__defmacro = (state, name) => (...args) => {
  ...
  //  -> S expr  : fn
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__defmacro', args, 3);
  return null;
};
const $apply = (state, name) => (...args) => {
  // S expression: ($apply fn arg1 ... argN)
  //  -> S expr  : fn'
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$apply', args, 1);
  const car = $$first(...args);
...
const $__call = (state, name) => (...args) => {
  ...
  //  -> S expr  : fn
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__call', args, 2);
  const {
    car,
    cdr
  } = $$firstAndSecond(...args);
...
const $__try = (state, name) => (...args) => {
  ...
  //  ->                               S expr  : expr
  //  -> (if error is raised in expr)  S expr  : catch-expr
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__try', args, 1, 2);
  let r = [];
...
const $__if = (state, name) => (...args) => {
  ...
  //  -> (if condition is true ) S expr  : t-expr
  //  -> (if condition is false) S expr  : f-expr
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__if', args, 2, 3);
  const car = $$first(...args);
  let r = [];
...
const $__ifNull = (state, name) => (...args) => {
  ...
  //  -> (if condition is not null ) S expr  : condition
  //  -> (if condition is null)      S expr  : null-expr
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__ifNull', args, 2, 2);
  const {
    car,
    cdr
  } = $$firstAndSecond(...args);
...
const $__cond = (state, name) => (...args) => {
  ...
  //  -> (if (eval condI) is true ) S expr  : exprI
  //  -> (if no matched)            S expr  : null
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__cond', args, 1);
...
const $__while = (state, name) => (...args) => {
  ...
  //  -> (if condition is true at least 1 or more times) S expr  : exprN
  //  -> (else)                                          S expr  : null
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__while', args, 1);
  const car = $$first(...args);
  const cdr = args.slice(1);
  let r = null;
...
const $__doWhile = (state, name) => (...args) => {
  ...
  //  -> (if condition is true at least 1 or more times) S expr  : exprN
  //  -> (else)                                          S expr  : null
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__doWhile', args, 1);
  const car = $$first(...args);
  const cdr = args.slice(1);
  let r = null;
...
const $__until = (state, name) => (...args) => {
  ...
  //  -> (if condition is true at least 1 or more times) S expr  : exprN
  //  -> (else)                                          S expr  : null
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__until', args, 1);
  const car = $$first(...args);
  const cdr = args.slice(1);
  let r = null;
...
const $__doUntil = (state, name) => (...args) => {
  ...
  //  -> (if condition is true at least 1 or more times) S expr  : exprN
  //  -> (else)                                          S expr  : null
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__doUntil', args, 1);
  const car = $$first(...args);
  const cdr = args.slice(1);
  let r = null;
...
const $__repeat = (state, name) => (...args) => {
  ...
  //  -> (if n > 0) S expr  : exprN
  //  -> (else)     S expr  : null
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__repeat', args, 2);
...
const $__for = (state, name) => (...args) => {
  ...
  //  -> (if list.length > 0) S expr  : exprN
  //  -> (else)               S expr  : null
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__for', args, 2);
  const sym = Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])($$first(...args));
...
const $pipe = (state, name) => (...args) => {
  ...
  //  -> S expr  : any
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$pipe', args, 1);
  let v = args[0];
...
const $__get = (state, name) => (...args) => {
  // S expression: ($__get 'nameOrIndex1 ... 'nameOrIndexN)
  //  -> S expr  : any
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__get', args, 1);
  let v = null;
...
const $__let = (state, name) => (...args) => {
  // S expression: ($__let 'nameStrOrSymbol expr)
  //  -> S expr  : any
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__let', args, 2, 2);
...
const $__set = (state, name) => (...args) => {
  // S expression: ($__set 'nameOrListOfNameOrIndex expr)
  //  -> S expr  : any
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__set', args, 2, 2);
  let path = [];
...
const $boolean = (state, name) => (...args) => {
  // S expression: ($boolean any)
  //  -> S expr  : boolean
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$boolean', args, 1, 1);
  const car = $$first(...args);
...
const $not = (state, name) => (...args) => {
  // S expression: ($not any)
  //  -> S expr  : boolean
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$not', args, 1, 1);
  return !$$boolean(...args);
};
...
const $__and = (state, name) => (...args) => {
  ...
  //  -> (if all of ($boolean expr1) ... ($boolean exprN) are true) S expr  : exprN
  //  -> (else)                                                     S expr  : expr-i (false left most)
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__and', args, 1);
  let prev = null;
...
const $__or = (state, name) => (...args) => {
  ...
  //  -> (if any ($boolean expr1) ... ($boolean exprN) are true) S expr  : expr-i (where i: index of item first ($boolean expr-i) is to be true)
  //  -> (else)                                                  S expr  : expr-i (false right most)
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$__or', args, 1);
  let prev = null;
...
const $ambiguousEq = (state, name) => (...args) => {
  // S expression: (== a b)
  //  -> S expr  : boolean
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$ambiguousEq', args, 2, 2);
  let {
    car,
    cdr
  } = $$firstAndSecond(...args);
...
const $lt = (state, name) => (...args) => {
  // S expression: (< a b)
  //  -> S expr  : boolean
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$lt', args, 2, 2);
  const {
    car,
    cdr
  } = $$firstAndSecond(...args);
...
const $le = (state, name) => (...args) => {
  // S expression: (<= a b)
  //  -> S expr  : boolean
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$le', args, 2, 2);
  const {
    car,
    cdr
  } = $$firstAndSecond(...args);
...
const $gt = (state, name) => (...args) => {
  // S expression: (> a b)
  //  -> S expr  : boolean
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$gt', args, 2, 2);
  const {
    car,
    cdr
  } = $$firstAndSecond(...args);
...
const $ge = (state, name) => (...args) => {
  // S expression: (>= a b)
  //  -> S expr  : boolean
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$ge', args, 2, 2);
  const {
    car,
    cdr
  } = $$firstAndSecond(...args);
...
const $gensym = (state, name) => (...args) => {
  // S expression: ($gensym)
  // S expression: ($gensym symbol)
  //  -> S expr  : symbol
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$gensym', args, 0, 1);
  const varBaseName = `$__tempvar__$$ec${state.evalCount++}$$_`;
  const tempVarSym = {
  ...
  if (args.length === 1) {
    const a = Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(args[0]);
...
const $isSymbol = (state, name) => (...args) => {
  ...
  //  -> S expr  : boolean
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$isSymbol', args, 1, 1);
  return Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(args[0]) ? true : false;
};
const $$isSymbol = $isSymbol(null, null);
const $isList = (state, name) => (...args) => {
  // S expression: ($is-list x)
  //  -> S expr  : boolean
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$isList', args, 1, 1);
...
const $isString = (state, name) => (...args) => {
  ...
  //  -> S expr  : boolean
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$isString', args, 1, 1);
...
const $isNumber = (state, name) => (...args) => {
  ...
  //  -> S expr  : boolean
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$isNumber', args, 1, 1);
...
const $isNaN = (state, name) => (...args) => {
  ...
  //  -> S expr  : boolean
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$isNaN', args, 1, 1);
...
const $isFinite = (state, name) => (...args) => {
  ...
  //  -> S expr  : boolean
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$isFinite', args, 1, 1);
...
const $isInteger = (state, name) => (...args) => {
  ...
  //  -> S expr  : boolean
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$isInteger', args, 1, 1);
...
const $toString = (state, name) => (...args) => {
  ...
  //  -> S expr  : string
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$toString', args, 1, 1);
...
const $toNumber = (state, name) => (...args) => {
  ...
  //  -> S expr  : number
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$toNumber', args, 1, 1);
...
const $objectAssign = (state, name) => (...args) => {
  ...
  //  -> S expr  : string
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$objectAssign', args, 1);
...
const $jsonStringify = (state, name) => (...args) => {
  ...
  //  -> S expr  : string
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$jsonStringify', args, 1, 1);
...
const $jsonParse = (state, name) => (...args) => {
  ...
  //  -> S expr  : object
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$jsonParse', args, 1, 1);
  const s = $$first(...args);
...
const $datetimeFromIso = (state, name) => (...args) => {
  ...
  //  -> S expr  : number
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$datetimeFromIso', args, 1, 1);
  const s = $$first(...args);
...
const $datetime = (state, name) => (...args) => {
  ...
  //  -> S expr  : number
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$datetime', args, 3, 7);
  let s = '';
...
const $datetimeLc = (state, name) => (...args) => {
  ...
  //  -> S expr  : number
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$datetimeLc', args, 3, 7);
  let s = '';
  const year = Number(args[0]);
...
const $datetimeToIsoString = (state, name) => (...args) => {
  ...
  //  -> S expr  : string
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$datetimeToIsoString', args, 1, 1);
  const n = $$first(...args);
...
const $datetimeToComponents = (state, name) => (...args) => {
  ...
  //  -> S expr  : list
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$datetimeToComponents', args, 1, 1);
  const n = $$first(...args);
...
const $datetimeToComponentsLc = (state, name) => (...args) => {
  ...
  //  -> S expr  : list
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$datetimeToComponentsLc', args, 1, 1);
  const n = $$first(...args);
...
const $match = (state, name) => (...args) => {
  ...
  //  -> S expr  : array
  Object(_errors__WEBPACK_IMPORTED_MODULE_3__["checkParamsLength"])('$match', args, 2, 3);
...
const macros = [{
  ...
  fn: (state, name) => list => {
    ...
    const symUse = Object(_types__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(list[2], 'use');
    ...
    return [{
      symbol: '$__capture'
    }, Object(_types__WEBPACK_IMPORTED_MODULE_0__["quote"])(state, list[3]), Object(_types__WEBPACK_IMPORTED_MODULE_0__["quote"])(state, [{
      symbol: '$__lambda'
    }, Object(_types__WEBPACK_IMPORTED_MODULE_0__["quote"])(state, list[1]), ...list.slice(4).map(x => Object(_types__WEBPACK_IMPORTED_MODULE_0__["quote"])(state, x))])];
  }
}, {
  name: '|->',
  fn: (state, name) => list => {
...
const funcs = [{
  ...
  name: '$gensym',
  fn: _core_fn__WEBPACK_IMPORTED_MODULE_0__["$gensym"]
}, {
  name: '$is-symbol',
      ...
      case ',':
        {
          ...
          skipWhitespaces(state);
          const ret = (ch === "'" ? _types__WEBPACK_IMPORTED_MODULE_0__["quote"] : ch === "`" ? _types__WEBPACK_IMPORTED_MODULE_0__["backquote"] : _types__WEBPACK_IMPORTED_MODULE_0__["wrapByUnquote"])(state, parseOneToken(state));
          return isSpliceUnquote ? Object(_types__WEBPACK_IMPORTED_MODULE_0__["splice"])(state, ret) : ret;
        }
      ...
      case "`":
        {
          ...
          for (;;) {
            ...
            if (typeof t === 'object' && Object.prototype.hasOwnProperty.call(t, 'comment')) {
              ...
              r.push((ch === "'" ? _types__WEBPACK_IMPORTED_MODULE_0__["quote"] : _types__WEBPACK_IMPORTED_MODULE_0__["backquote"])(state, t));
              break;
            }
          }
...
/*!****************************!*\
  !*** ./src/s-exp/types.ts ***!
  \****************************/
/*! exports provided: quote, isQuoted, backquote, isBackquoted, wrapByUnquote, isUnquoted, spread, splice, isSymbol, FatalError, MaxEvaluationCountError, ScriptTerminationError */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
