    ...
    if (b === null) {
      ...
      case 'object':
        if (Object(_ast__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(b)) {
          const sym = b;
          Object(_errors__WEBPACK_IMPORTED_MODULE_2__["checkUnsafeVarNames"])('(compiler)compileValue', sym.symbol);
        ...
        if (Array.isArray(r)) {
          if (0 < r.length) {
            if (Object(_ast__WEBPACK_IMPORTED_MODULE_0__["isSymbol"])(r[0])) {
              ...
              Object(_errors__WEBPACK_IMPORTED_MODULE_2__["checkUnsafeVarNames"])('(compiler)compileToken', sym.symbol);
...
/*!*****************************!*\
  !*** ./src/s-exp/errors.ts ***!
  \*****************************/
/*! exports provided: setEvaluationCount, checkParamsLength, checkUnsafeVarNames */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function collectCapturedVariables(state, names) {
  const capturedScopes = Object.create(null);
  ...
  for (const n of names) {
    ...
    Object(_errors__WEBPACK_IMPORTED_MODULE_1__["checkUnsafeVarNames"])('collectCapturedVariables', n.symbol);
  ...
  if (Array.isArray(car)) {
    for (const x of car) {
      if (Array.isArray(x)) {
        ...
        Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNames"])('$__scope', kvName);
        scope[kvName] = Object(_evaluate__WEBPACK_IMPORTED_MODULE_2__["evaluate"])(state, kv.cdr);
      } else {
        const xSym = Object(_ast__WEBPACK_IMPORTED_MODULE_1__["isSymbol"])(x);
        const xName = xSym ? xSym.symbol : String(x);
        Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNames"])('$__scope', xName);
        scope[xName] = null;
      }
    }
  }
...
const $__capture = (state, name) => (...args) => {
  ...
  Object(_evaluate__WEBPACK_IMPORTED_MODULE_2__["installScope"])(state, Object.create(null), true, capturedScopes);
...
const $__defun = (state, name) => (...args) => {
  ...
  Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNames"])('$__defun', car.symbol); // TODO: overloading
...
const $__refun = (state, name) => (...args) => {
  ...
  const car = $$first(...args);
  Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNames"])('$__refun', car.symbol);
...
const $__defmacro = (state, name) => (...args) => {
  ...
  Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNames"])('$__defmacro', car.symbol);
...
const $__call = (state, name) => (...args) => {
  ...
  const xName = sym ? sym.symbol : Object(_evaluate__WEBPACK_IMPORTED_MODULE_2__["evaluate"])(state, cdr);
  Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNames"])('$__call', xName);
...
const $__repeat = (state, name) => (...args) => {
  ...
  Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNames"])('$__repeat', sym.symbol);
...
const $__for = (state, name) => (...args) => {
  ...
  Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNames"])('$__for', sym.symbol);
  const scope = Object(_evaluate__WEBPACK_IMPORTED_MODULE_2__["resolveValueSymbolScope"])(state, sym, false);
  ...
  for (let i = 1; i < args.length; i++) {
    ...
    while (inprog) {
      switch (typeof q) {
        ...
        case 'string':
          Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNames"])('$__get', q);
          v = v[q];
          inprog = false;
          break;
...
const $__let = (state, name) => (...args) => {
  ...
  Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNames"])('$__let', sym.symbol);
  const scope = Object(_evaluate__WEBPACK_IMPORTED_MODULE_2__["resolveValueSymbolScope"])(state, sym, false);
...
const $__set = (state, name) => (...args) => {
  ...
  if (!sym) {
    if (typeof path[0] === 'string') {
      Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNames"])('$__set', path[0]);
      sym = {
        symbol: path[0]
      };
    } else {
  ...
  for (let i = 0; i < path.length; i++) {
    ...
    while (inprog) {
      switch (typeof q) {
        ...
        case 'string':
          Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNames"])('$__set', q);
...
const $__toObject = (state, name) => (...args) => {
  ...
  for (const x of args) {
    if (Array.isArray(x) && 0 < x.length) {
      ...
      Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNames"])('$__#', keyName);
  ...
  for (const x of args) {
    if (Array.isArray(x) && 0 < x.length) {
      ...
      switch (keyName) {
        ...
        default:
          {
            Object(_errors__WEBPACK_IMPORTED_MODULE_2__["checkUnsafeVarNames"])('$jsxProps', keyName);
...
const L = (() => {
  let config = Object.assign(Object.create(null), defaultConfig);
