...
const $__lambda = (state, name) => (...args) => {
  ...
  const fn = function (...actualArgs) {
    ...
    return $__scope(state, name, capturedScopes)(false, false, [[state.config.reservedNames.self, fn], [state.config.reservedNames.thiz, this === globalObj || this === void 0 ? null : Object(_ast__WEBPACK_IMPORTED_MODULE_1__["quote"])(state, this)], ...formalArgs.map((x, index) => [x.symbol, Object(_ast__WEBPACK_IMPORTED_MODULE_1__["quote"])(state, lastIsSpread && index === formalArgs.length - 1 ? actualArgs.slice(index) : actualArgs[index])])], ...fnBody);
  };
