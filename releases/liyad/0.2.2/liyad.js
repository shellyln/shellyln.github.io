  ...
  if (Array.isArray(car)) {
    for (const x of car) {
      if (Array.isArray(x)) {
        ...
        Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNamesEx"])('$__scope', scope, kvName);
        ...
        Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNamesEx"])('$__scope', scope, xName);
        scope[xName] = null;
      }
    }
  }
...
const $__defun = (state, name) => (...args) => {
  ...
  Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNamesEx"])('$__defun', state.funcMap, car.symbol); // TODO: overloading
...
const $__refun = (state, name) => (...args) => {
  ...
  const car = $$first(...args);
  Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNamesEx"])('$__refun', state.funcMap, car.symbol);
...
const $__defmacro = (state, name) => (...args) => {
  ...
  Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNamesEx"])('$__defmacro', state.macroMap, car.symbol);
...
const $__call = (state, name) => (...args) => {
  ...
  Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNamesEx"])('$__call', car, xName);
...
const $__repeat = (state, name) => (...args) => {
  ...
  Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNamesEx"])('$__repeat', {}, sym.symbol); // NOTE: pass dummy target object.
...
const $__for = (state, name) => (...args) => {
  ...
  Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNamesEx"])('$__for', {}, sym.symbol); // NOTE: pass dummy target object.
  ...
  for (let i = 1; i < args.length; i++) {
    ...
    while (inprog) {
      switch (typeof q) {
        ...
        case 'string':
          Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNamesEx"])('$__get', v, q);
          v = v[q];
          inprog = false;
          break;
...
const $__let = (state, name) => (...args) => {
  ...
  Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNamesEx"])('$__let', {}, sym.symbol); // NOTE: pass dummy target object.
...
const $__set = (state, name) => (...args) => {
  ...
  if (!sym) {
    if (typeof path[0] === 'string') {
      Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNamesEx"])('$__set', {}, path[0]); // NOTE: pass dummy target object.
  ...
  for (let i = 0; i < path.length; i++) {
    ...
    while (inprog) {
      switch (typeof q) {
        ...
        case 'string':
          Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNamesEx"])('$__set', scope, q);
...
const $__toObject = (state, name) => (...args) => {
  ...
  for (const x of args) {
    if (Array.isArray(x) && 0 < x.length) {
      ...
      Object(_errors__WEBPACK_IMPORTED_MODULE_4__["checkUnsafeVarNamesEx"])('$__#', r, keyName);
...
const assignBlacklists = [Object.__proto__, {}.__proto__, Function.__proto__];
