...
/* harmony import */ var _global_this__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./global-this */ "./src/s-exp/global-this.ts");
// Copyright (c) 2018, Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
...
function checkUnsafeVarNames(name, varName) {
  ...
  if (_global_this__WEBPACK_IMPORTED_MODULE_1__["objConstructor"].hasOwnProperty(varName)) {
    throw new Error(`[SX] ${name}: Invalid var name ${varName}.`);
  }
...
function checkUnsafeVarNamesEx(name, target, varName) {
  if (target === _global_this__WEBPACK_IMPORTED_MODULE_1__["globalObj"] || varName === '__proto__' || varName === '__defineGetter__' || varName === '__defineSetter__' || varName === '__lookupGetter__' || varName === '__lookupSetter__') {
    throw new Error(`[SX] ${name}: Invalid var name ${varName}.`);
  }
  ...
  if (target === null || target === void 0 || target === _global_this__WEBPACK_IMPORTED_MODULE_1__["objConstructor"]) {
    if (_global_this__WEBPACK_IMPORTED_MODULE_1__["objConstructor"].hasOwnProperty(varName)) {
      throw new Error(`[SX] ${name}: Invalid var name ${varName}.`);
    }
  }

  if (target === null || target === void 0 || target === _global_this__WEBPACK_IMPORTED_MODULE_1__["funConstructor"]) {
    // checking 'call', 'arguments', 'caller', ...
    let con = _global_this__WEBPACK_IMPORTED_MODULE_1__["funConstructor"];
...
/***/ "./src/s-exp/global-this.ts":
/*!**********************************!*\
  !*** ./src/s-exp/global-this.ts ***!
  \**********************************/
/*! exports provided: dummyTargetObject, globalObj, objConstructor, funConstructor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/s-exp/interpreters/index.ts":
/*!*****************************************!*\
  !*** ./src/s-exp/interpreters/index.ts ***!
  \*****************************************/
...
/* harmony import */ var _evaluate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../evaluate */ "./src/s-exp/evaluate.ts");
/* harmony import */ var _defaults__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../defaults */ "./src/s-exp/defaults.ts");
// Copyright (c) 2018, Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
...
/***/ "./src/s-exp/interpreters/presets/lisp.ts":
/*!************************************************!*\
  !*** ./src/s-exp/interpreters/presets/lisp.ts ***!
  \************************************************/
/*! exports provided: L, LS, lisp, L_async, LS_async, lisp_async, LM, LM_async */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _operators_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../operators/core */ "./src/s-exp/operators/core/index.ts");
/* harmony import */ var _operators_arithmetic__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../operators/arithmetic */ "./src/s-exp/operators/arithmetic/index.ts");
/* harmony import */ var _operators_sequence__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../operators/sequence */ "./src/s-exp/operators/sequence/index.ts");
/* harmony import */ var _operators_concurrent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../operators/concurrent */ "./src/s-exp/operators/concurrent/index.ts");
/* harmony import */ var _interpreters__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../interpreters */ "./src/s-exp/interpreters/index.ts");
/* harmony import */ var _defaults__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../defaults */ "./src/s-exp/defaults.ts");
// Copyright (c) 2018, Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
...
const L = (() => {
  let config = Object.assign({}, _defaults__WEBPACK_IMPORTED_MODULE_5__["defaultConfig"]);
  config.reservedNames = Object.assign({}, config.reservedNames, {
    Template: '$concat'
  });
  config = Object(_operators_core__WEBPACK_IMPORTED_MODULE_0__["default"])(config);
  config = Object(_operators_arithmetic__WEBPACK_IMPORTED_MODULE_1__["default"])(config);
  config = Object(_operators_sequence__WEBPACK_IMPORTED_MODULE_2__["default"])(config);
  config = Object(_operators_concurrent__WEBPACK_IMPORTED_MODULE_3__["default"])(config);
  config.stripComments = true;
  return Object(_interpreters__WEBPACK_IMPORTED_MODULE_4__["SExpression"])(config);
})();
const LS = L;
...
const L_async = (() => {
  ...
  config = Object(_operators_concurrent__WEBPACK_IMPORTED_MODULE_3__["default"])(config);
  config.stripComments = true;
  return Object(_interpreters__WEBPACK_IMPORTED_MODULE_4__["SExpressionAsync"])(config);
})(); // tslint:disable-next-line:variable-name
...
/***/ "./src/s-exp/interpreters/presets/lsx.ts":
/*!***********************************************!*\
  !*** ./src/s-exp/interpreters/presets/lsx.ts ***!
  \***********************************************/
/*! exports provided: LSX, LSX_async */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _operators_arithmetic__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../operators/arithmetic */ "./src/s-exp/operators/arithmetic/index.ts");
/* harmony import */ var _operators_sequence__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../operators/sequence */ "./src/s-exp/operators/sequence/index.ts");
/* harmony import */ var _operators_jsx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../operators/jsx */ "./src/s-exp/operators/jsx/index.ts");
/* harmony import */ var _operators_concurrent__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../operators/concurrent */ "./src/s-exp/operators/concurrent/index.ts");
/* harmony import */ var _interpreters__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../interpreters */ "./src/s-exp/interpreters/index.ts");
/* harmony import */ var _defaults__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../defaults */ "./src/s-exp/defaults.ts");
// Copyright (c) 2018, Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
...
function LSX(lsxConf) {
  let config = Object.assign({}, _defaults__WEBPACK_IMPORTED_MODULE_6__["defaultConfig"]);
  config = Object(_operators_core__WEBPACK_IMPORTED_MODULE_0__["default"])(config);
  config = Object(_operators_arithmetic__WEBPACK_IMPORTED_MODULE_1__["default"])(config);
  config = Object(_operators_sequence__WEBPACK_IMPORTED_MODULE_2__["default"])(config);
  config = Object(_operators_concurrent__WEBPACK_IMPORTED_MODULE_4__["default"])(config);
  config = Object(_operators_jsx__WEBPACK_IMPORTED_MODULE_3__["default"])(config, lsxConf);
  config.stripComments = true;
  return Object(_interpreters__WEBPACK_IMPORTED_MODULE_5__["SExpression"])(config);
}
function LSX_async(lsxConf) {
  ...
  config = Object(_operators_jsx__WEBPACK_IMPORTED_MODULE_3__["default"])(config, lsxConf);
  config.stripComments = true;
  return Object(_interpreters__WEBPACK_IMPORTED_MODULE_5__["SExpressionAsync"])(config);
}

/***/ }),

/***/ "./src/s-exp/interpreters/presets/s-exp.ts":
/*!*************************************************!*\
  !*** ./src/s-exp/interpreters/presets/s-exp.ts ***!
  \*************************************************/
/*! exports provided: S */
...
/* harmony import */ var _interpreters__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../interpreters */ "./src/s-exp/interpreters/index.ts");
/* harmony import */ var _defaults__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../defaults */ "./src/s-exp/defaults.ts");
// Copyright (c) 2018, Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
...
const S = (() => {
  const config = Object.assign({}, _defaults__WEBPACK_IMPORTED_MODULE_1__["defaultConfig"]);
  config.enableEvaluate = false;
  config.returnMultipleRoot = true;
  return Object(_interpreters__WEBPACK_IMPORTED_MODULE_0__["SExpression"])(config);
})();
...
const assignBlacklist = [_global_this__WEBPACK_IMPORTED_MODULE_1__["globalObj"], Object.__proto__, {}.__proto__, Function.__proto__];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _defaults__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./defaults */ "./src/s-exp/defaults.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "defaultReservedNames", function() { return _defaults__WEBPACK_IMPORTED_MODULE_0__["defaultReservedNames"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "defaultConfig", function() { return _defaults__WEBPACK_IMPORTED_MODULE_0__["defaultConfig"]; });

/* harmony import */ var _interpreters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./interpreters */ "./src/s-exp/interpreters/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SExpression", function() { return _interpreters__WEBPACK_IMPORTED_MODULE_1__["SExpression"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SExpressionAsync", function() { return _interpreters__WEBPACK_IMPORTED_MODULE_1__["SExpressionAsync"]; });

/* harmony import */ var _interpreters_presets_s_exp__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./interpreters/presets/s-exp */ "./src/s-exp/interpreters/presets/s-exp.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "S", function() { return _interpreters_presets_s_exp__WEBPACK_IMPORTED_MODULE_2__["S"]; });

/* harmony import */ var _interpreters_presets_lisp__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./interpreters/presets/lisp */ "./src/s-exp/interpreters/presets/lisp.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "L", function() { return _interpreters_presets_lisp__WEBPACK_IMPORTED_MODULE_3__["L"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LS", function() { return _interpreters_presets_lisp__WEBPACK_IMPORTED_MODULE_3__["LS"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "lisp", function() { return _interpreters_presets_lisp__WEBPACK_IMPORTED_MODULE_3__["lisp"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "L_async", function() { return _interpreters_presets_lisp__WEBPACK_IMPORTED_MODULE_3__["L_async"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LS_async", function() { return _interpreters_presets_lisp__WEBPACK_IMPORTED_MODULE_3__["LS_async"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "lisp_async", function() { return _interpreters_presets_lisp__WEBPACK_IMPORTED_MODULE_3__["lisp_async"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LM", function() { return _interpreters_presets_lisp__WEBPACK_IMPORTED_MODULE_3__["LM"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LM_async", function() { return _interpreters_presets_lisp__WEBPACK_IMPORTED_MODULE_3__["LM_async"]; });

/* harmony import */ var _interpreters_presets_lsx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./interpreters/presets/lsx */ "./src/s-exp/interpreters/presets/lsx.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LSX", function() { return _interpreters_presets_lsx__WEBPACK_IMPORTED_MODULE_4__["LSX"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LSX_async", function() { return _interpreters_presets_lsx__WEBPACK_IMPORTED_MODULE_4__["LSX_async"]; });
