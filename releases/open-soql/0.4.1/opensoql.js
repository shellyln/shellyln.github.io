...
/*!************************!*\
  !*** ./src/filters.ts ***!
  \************************/
/*! exports provided: applyWhereConditions, applyHavingConditions, getIndexFieldConditions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
          ...
          default:
            switch (op.type) {
              ...
              case 'parameter':
                ...
                v = (_a = ctx.params[op.name]) !== null && _a !== void 0 ? _a : null;
                break;
...
function getIndexFieldConditions(conds, indexFieldNames) {
  const indexFieldNamesI = indexFieldNames.map(x => x.toLowerCase());
  const tmp = Object(_lib_condition__WEBPACK_IMPORTED_MODULE_1__["pruneNonIndexFieldConditions"])({
    type: 'condition',
    op: 'and',
...
/*!**********************!*\
  !*** ./src/index.ts ***!
  \**********************/
/*! exports provided: applyWhereConditions, applyHavingConditions, getIndexFieldConditions, sortRecords, build, setDefaultStaticResolverConfig, staticJsonResolverBuilder, staticCsvResolverBuilder, passThroughResolverBuilder */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!******************************!*\
  !*** ./src/lib/condition.ts ***!
  \******************************/
/*! exports provided: filterZeroLengthCondFn, pruneCondition, flatConditions, pruneNonIndexFieldConditions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function filterIndexFieldCondOperands(cond, indexFieldNamesI) {
  cond.operands = cond.operands.map(x => {
    switch (typeof x) {
      case 'object':
        if (Array.isArray(x)) {
...
function pruneNonIndexFieldConditions(cond, indexFieldNamesI) {
  if (cond.operands.length) {
    const x = cond.operands[0];
