...
class Query {
  constructor(query, runCompiledQuery) {
    this.query = query;
    this.runCompiledQuery = runCompiledQuery; // nothing to do.
  }
...
function build(builder) {
  ...
  class Publisher {
    ...
    toPublishFn() {
      return (resolver, on, data) => this.publish(resolver, on, data);
    }
  ...
  function subscribe(resolver, id, fn) {
    if (!subscribers[resolver]) {
      subscribers[resolver] = new Map();
    }
  ...
  function unsubscribe(resolver, id, fn) {
    if (!subscribers[resolver]) {
      return;
    }
  ...
  function unsubscribeAllBySubscriber(resolver, fn) {
    if (!subscribers[resolver]) {
      return;
    }
  ...
  function createTransactionScope(scopeTr, scopeTrOptions, scopePublisher, isIsolated) {
    const scopePub = scopePublisher === null || scopePublisher === void 0 ? void 0 : scopePublisher.toPublishFn();

    function withTransactionEvents(tr, trOptions, publisher, run) {
      return __awaiter(this, void 0, void 0, function* () {
        try {
          ...
          const ret = yield run(tr, trOptions, publisher.toPublishFn());
          ...
          publisher.fire(); // eslint-disable-next-line @typescript-eslint/no-unsafe-return
    ...
    function runCompiledQuery(query, params) {
      return __awaiter(this, void 0, void 0, function* () {
        const run = (tr, trOptions, publish) => __awaiter(this, void 0, void 0, function* () {
          const ret = yield Object(_lib_run_query__WEBPACK_IMPORTED_MODULE_1__["executeCompiledQuery"])(preparedBI, params !== null && params !== void 0 ? params : {}, tr, trOptions, query, null, null, null, null);
        ...
        if (isIsolated) {
          return yield withTransactionEvents({}, void 0, new Publisher(), run);
        } else {
          // eslint-disable-next-line @typescript-eslint/no-unsafe-return, @typescript-eslint/no-non-null-assertion
          return yield run(scopeTr, scopeTrOptions, scopePub);
        }
      });
    }

    function compileQuery(strings, ...values) {
    ...
    function runQuery(strings, ...values) {
      return __awaiter(this, void 0, void 0, function* () {
        const run = (tr, trOptions, publish) => __awaiter(this, void 0, void 0, function* () {
          const query = Object(_lib_prepare__WEBPACK_IMPORTED_MODULE_0__["prepareQuery"])(preparedBI, strings, ...values);
          const ret = yield Object(_lib_run_query__WEBPACK_IMPORTED_MODULE_1__["executeCompiledQuery"])(preparedBI, {}, tr, trOptions, query, null, null, null, null);
    ...
    function runRemove(resolver, obj) {
      return __awaiter(this, void 0, void 0, function* () {
        const run = (tr, trOptions, publish) => __awaiter(this, void 0, void 0, function* () {
          // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
          const data = Array.isArray(obj) ? obj : [obj]; // eslint-disable-next-line @typescript-eslint/no-unsafe-return

          yield Object(_lib_run_dml__WEBPACK_IMPORTED_MODULE_2__["executeRemoveDML"])(preparedBI, tr, trOptions, resolver, data);
    ...
    function runNotifyGen(resolver, on, obj) {
      return __awaiter(this, void 0, void 0, function* () {
        const run = (tr, trOptions, publish) => {
          // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
    ...
    function runTouch(resolver, obj) {
      return __awaiter(this, void 0, void 0, function* () {
        return runNotifyGen(resolver, 'update', obj);
      });
    }

    function runNotifyRemoved(resolver, obj) {
      return __awaiter(this, void 0, void 0, function* () {
        return runNotifyGen(resolver, 'remove', obj);
      });
    }
    ...
    function transaction(callback, trOptions) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const run = (tr, _trOptions, _publish) => __awaiter(this, void 0, void 0, function* () {
          yield callback({
        ...
        return yield withTransactionEvents(tr, trOptions, publisher, run);
      });
    }
...
/*!************************!*\
  !*** ./src/filters.ts ***!
  \************************/
/*! exports provided: applyWhereConditions, applyHavingConditions, getIndexFieldConditions, getSqlConditionString, escapeSqlStringLiteral_Std, escapeSqlStringLiteral_MySql */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getIndexFieldConditions", function() { return getIndexFieldConditions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSqlConditionString", function() { return getSqlConditionString; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "escapeSqlStringLiteral_Std", function() { return escapeSqlStringLiteral_Std; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "escapeSqlStringLiteral_MySql", function() { return escapeSqlStringLiteral_MySql; });
/* harmony import */ var _lib_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/util */ "./src/lib/util.ts");
/* harmony import */ var _lib_condition__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/condition */ "./src/lib/condition.ts");
/* harmony import */ var _lib_call__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lib/call */ "./src/lib/call.ts");
/* harmony import */ var _lib_cache__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lib/cache */ "./src/lib/cache.ts");
// Copyright (c) 2020 Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
...
const getOp1AggregateFnValue = (fieldNameMap, ctx, cache, record) => {
  ...
  return Object(_lib_call__WEBPACK_IMPORTED_MODULE_2__["callAggregateFunction"])(ctx, op, fnInfo, op2FieldResultType, record);
};
...
const getOp1ScalarOnAggFnValue = (fieldNameMap, ctx, cache, record) => {
  ...
  return Object(_lib_call__WEBPACK_IMPORTED_MODULE_2__["callScalarFunction"])(ctx, op, fnInfo, op2FieldResultType, firstRec, record);
};
...
const getOp1ScalarOnNonAggFnValue = (fieldNameMap, ctx, cache, record) => {
  ...
  return Object(_lib_call__WEBPACK_IMPORTED_MODULE_2__["callScalarFunction"])(ctx, op, fnInfo, op2FieldResultType, record, null);
};
...
const getOp1ImmediateScalarOnAggFnValue = (fieldNameMap, ctx, cache, record) => {
  ...
  return Object(_lib_call__WEBPACK_IMPORTED_MODULE_2__["callImmediateScalarFunction"])(ctx, op, fnInfo, op2FieldResultType, null, record);
};
...
const getOp1ImmediateScalarOnNonAggFnValue = (fieldNameMap, ctx, cache, record) => {
  ...
  return Object(_lib_call__WEBPACK_IMPORTED_MODULE_2__["callImmediateScalarFunction"])(ctx, op, fnInfo, op2FieldResultType, record, null);
};

function createOp1Cache(groupFields, isAggregation, ctx, cond) {
  let cache = _lib_cache__WEBPACK_IMPORTED_MODULE_3__["condOp1FnCache"].get(cond);
      ...
      if (op === null) {// nothing to do (v is null)
        ...
        switch (op.type) {
          case 'field':
            ...
            _lib_cache__WEBPACK_IMPORTED_MODULE_3__["condOp1FnCache"].set(cond, cache);
            break;
          ...
          case 'fncall':
            {
              ...
              switch (fnInfo === null || fnInfo === void 0 ? void 0 : fnInfo.type) {
                ...
                case 'scalar':
                  if (isAggregation) {
                    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                    if (!Object(_lib_call__WEBPACK_IMPORTED_MODULE_2__["isScalarFnCallable"])(ctx, groupFields, op.args)) {
...
function getOp1Value(fieldNameMap, groupFields, isAggregation, ctx, cond, record) {
  ...
  let v = null;
  const op = cond.operands[0];
  const cache = (_a = _lib_cache__WEBPACK_IMPORTED_MODULE_3__["condOp1FnCache"].get(cond)) !== null && _a !== void 0 ? _a : createOp1Cache(groupFields, isAggregation, ctx, cond);
...
function getOp2Value(ctx, cond, record) {
  ...
  const cached = _lib_cache__WEBPACK_IMPORTED_MODULE_3__["condOp2ValueCache"].get(cond);
          ...
          case 'parameter':
            {
              ...
              const z = (_a = ctx.params[x.name]) !== null && _a !== void 0 ? _a : null;
          ...
          case 'fncall':
            {
              ...
              switch (fnInfo === null || fnInfo === void 0 ? void 0 : fnInfo.type) {
                case 'immediate-scalar':
                  // NOTE: It is UNSAFE!
                  v = Object(_lib_call__WEBPACK_IMPORTED_MODULE_2__["callImmediateScalarFunction"])(ctx, op, fnInfo, 'any', null, null);
                  break;
              ...
              case 'parameter':
                {
                  ...
                  const z = (_a = ctx.params[op.name]) !== null && _a !== void 0 ? _a : null;
  ...
  switch (cond.op) {
    ...
    case 'not_like':
      ...
      v = new RegExp(Object(_lib_util__WEBPACK_IMPORTED_MODULE_0__["convertPattern"])(v), 'i');
      break;
  ...
  _lib_cache__WEBPACK_IMPORTED_MODULE_3__["condOp2ValueCache"].set(cond, {
    value: v
  });
  return v;
}
...
function evalRecursiveCondition(fieldNameMap, groupFields, isAggregation, ctx, w, record) {
  ...
  return evalCondition(fieldNameMap, groupFields, isAggregation, ctx, w, record); // let ret = true;
  //
  // switch (typeof w) {
  // case 'object':
  //     if (Array.isArray(w)) {
...
function getIndexFieldConditions(ctx, conds, indexFieldNames) {
  const indexFieldNamesI = indexFieldNames.map(x => x.toLowerCase());
  const tmp = Object(_lib_condition__WEBPACK_IMPORTED_MODULE_1__["pruneNonIndexFieldConditions"])(ctx, {
    type: 'condition',
    op: 'and',
    operands: Object(_lib_util__WEBPACK_IMPORTED_MODULE_0__["deepCloneObject"])(conds)
  }, indexFieldNamesI);
  const ret = [];
  Object(_lib_condition__WEBPACK_IMPORTED_MODULE_1__["flatConditions"])(ret, 'and', tmp);
  return ret;
}
function getSqlConditionString(ctx, conds, dialect) {
  return conds.map(x => Object(_lib_condition__WEBPACK_IMPORTED_MODULE_1__["getSqlConditionStringImpl"])(ctx, x, dialect)).join(' and ');
}
function escapeSqlStringLiteral_Std(s) {
  return s.replace(/'/g, "''");
}
function escapeSqlStringLiteral_MySql(s) {
...
/*!**********************!*\
  !*** ./src/index.ts ***!
  \**********************/
/*! exports provided: applyWhereConditions, applyHavingConditions, getIndexFieldConditions, getSqlConditionString, escapeSqlStringLiteral_Std, escapeSqlStringLiteral_MySql, sortRecords, build, setDefaultStaticResolverConfig, staticJsonResolverBuilder, staticCsvResolverBuilder, passThroughResolverBuilder */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getIndexFieldConditions", function() { return _filters__WEBPACK_IMPORTED_MODULE_1__["getIndexFieldConditions"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getSqlConditionString", function() { return _filters__WEBPACK_IMPORTED_MODULE_1__["getSqlConditionString"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "escapeSqlStringLiteral_Std", function() { return _filters__WEBPACK_IMPORTED_MODULE_1__["escapeSqlStringLiteral_Std"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "escapeSqlStringLiteral_MySql", function() { return _filters__WEBPACK_IMPORTED_MODULE_1__["escapeSqlStringLiteral_MySql"]; });
...
/*!**************************!*\
  !*** ./src/lib/cache.ts ***!
  \**************************/
/*! exports provided: condOp1FnCache, condOp2ValueCache, nestedFnInfoCache, memoizedFnCache */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "memoizedFnCache", function() { return memoizedFnCache; });
// Copyright (c) 2020 Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
...
const memoizedFnCache = new WeakMap();
          ...
          case 'parameter':
            {
              ...
              const z = (_a = ctx.params[a.name]) !== null && _a !== void 0 ? _a : null;
...
function callImmediateScalarFunction(ctx, field, fnInfo, fieldResultType, record, groupedRecs) {
  const cached = _cache__WEBPACK_IMPORTED_MODULE_1__["memoizedFnCache"].get(field.args);
  ...
  if (!hasNonImmediate) {
    // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
    _cache__WEBPACK_IMPORTED_MODULE_1__["memoizedFnCache"].set(field.args, {
      value: ret
    });
  } // eslint-disable-next-line @typescript-eslint/no-unsafe-return
...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util */ "./src/lib/util.ts");
/* harmony import */ var _condition__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./condition */ "./src/lib/condition.ts");
// Copyright (c) 2020 Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
...
function normalize(builder, query, parentName, parentAliases) {
  ...
  if (query.where) {
    const c = [];
    Object(_condition__WEBPACK_IMPORTED_MODULE_1__["flatConditions"])(c, 'and', query.where[0]);
    query.where = c;
  }

  if (query.having) {
    const c = [];
    Object(_condition__WEBPACK_IMPORTED_MODULE_1__["flatConditions"])(c, 'and', query.having[0]);
    query.having = c;
...
/*!******************************!*\
  !*** ./src/lib/condition.ts ***!
  \******************************/
/*! exports provided: filterZeroLengthCondFn, pruneCondition, flatConditions, pruneNonIndexFieldConditions, getSqlConditionStringImpl */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "filterZeroLengthCondFn", function() { return filterZeroLengthCondFn; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pruneCondition", function() { return pruneCondition; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "flatConditions", function() { return flatConditions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pruneNonIndexFieldConditions", function() { return pruneNonIndexFieldConditions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSqlConditionStringImpl", function() { return getSqlConditionStringImpl; });
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util */ "./src/lib/util.ts");
// Copyright (c) 2020 Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
...
function getParameterValueDenyArray(ctx, x) {
  var _a;
...
function getParameterValueAllowArray(ctx, x) {
  var _a;
...
function filterIndexFieldCondOperands(ctx, cond, indexFieldNamesI) {
  cond.operands = cond.operands.map(x => {
    switch (typeof x) {
      case 'object':
        if (Array.isArray(x)) {
...
function pruneNonIndexFieldConditions(ctx, cond, indexFieldNamesI) {
  if (cond.operands.length) {
    {
      const x = cond.operands[0];
    ...
    }
    {
      ...
      switch (typeof y) {
        case 'object':
          if (y === null || Array.isArray(y)) {// NOTE: Nothing to do.
          } else {
            switch (y.type) {
              case 'fncall':
              case 'subquery':
              ...
              case 'parameter':
                return filterIndexFieldCondOperands(ctx, {
                  type: 'condition',
                  op: cond.op,
                  operands: [cond.operands[0], getParameterValueAllowArray(ctx, y), ...cond.operands.slice(2)]
                }, indexFieldNamesI);
            }
          }
...
function getSqlConditionStringImpl(ctx, cond, dialect) {
  switch (cond.op) {
    case 'not':
      return (// NOTE: It is unsafe, but compiler do not generate invalid condition tree.
        //       `x` should be `PreparedCondition`.
        `(not ${getSqlConditionStringImpl(ctx, cond.operands[0], dialect)})`
      );

    case 'and':
    case 'or':
      return `(${cond.operands // NOTE: It is unsafe, but compiler do not generate invalid condition tree.
      //       `x` should be `PreparedCondition`.
      .map(x => getSqlConditionStringImpl(ctx, x, dialect)).join(` ${cond.op} `)})`;
  ...
  const getEscapedParamValue = (x, allowArray) => {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fnInfo_convertTimezone", function() { return fnInfo_convertTimezone; });
...
/* harmony import */ var _protection__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./protection */ "./src/lib/protection.ts");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./util */ "./src/lib/util.ts");
// Copyright (c) 2020 Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
...
const symbolStringValue = trans(tokens => {
  ...
  if (Object(_protection__WEBPACK_IMPORTED_MODULE_4__["isUnsafeVarNames"])(_protection__WEBPACK_IMPORTED_MODULE_4__["dummyTargetObject"], sym)) {
...
const symbolName = trans(tokens => {
  if (Object(_protection__WEBPACK_IMPORTED_MODULE_4__["isUnsafeVarNames"])(_protection__WEBPACK_IMPORTED_MODULE_4__["dummyTargetObject"], tokens[0])) {
...
const parameterizedValue = trans(tokens => [{
  type: 'parameter',
  name: tokens[0]
}])(erase(seq(':')), symbolName);
const literalValue = first(isParam(o => {
        ...
        switch (o.type) {
          case 'date':
            ...
            if (typeof o.value === 'string') {
              // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
              return _util__WEBPACK_IMPORTED_MODULE_5__["DatePattern"].test(o.value);
            }
          ...
          case 'datetime':
            ...
            if (typeof o.value === 'string') {
              // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
              return _util__WEBPACK_IMPORTED_MODULE_5__["DateTimePattern"].test(o.value);
            }
  ...
  return false;
}), dateTimeValue, dateValue, numberValue, stringValue, trueValue, falseValue, nullValue, parameterizedValue);
...
trans(tokens => [{
  offset: tokens[0]
}])(erase(repeat(commentOrSpace), wordBoundary), erase(seqI('offset'), qty(1)(commentOrSpace)), first(decimalIntegerValue, parameterizedValue, isParam(o => typeof o === 'number')));
const limitClause = // eslint-disable-next-line @typescript-eslint/no-unsafe-return
trans(tokens => [{
  limit: tokens[0]
}])(erase(repeat(commentOrSpace), wordBoundary), erase(seqI('limit'), qty(1)(commentOrSpace)), first(decimalIntegerValue, parameterizedValue, isParam(o => typeof o === 'number')));
...
/*!*******************************!*\
  !*** ./src/lib/protection.ts ***!
  \*******************************/
/*! exports provided: dummyTargetObject, globalObj, objConstructor, funConstructor, isUnsafeVarNames */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "funConstructor", function() { return funConstructor; });
...
const dummyTargetObject = {}; // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util */ "./src/lib/util.ts");
/* harmony import */ var _condition__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./condition */ "./src/lib/condition.ts");
/* harmony import */ var _call__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./call */ "./src/lib/call.ts");
/* harmony import */ var _sort__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../sort */ "./src/sort.ts");
/* harmony import */ var _filters__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../filters */ "./src/filters.ts");
// Copyright (c) 2020 Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
var __awaiter = undefined && undefined.__awaiter || function (thisArg, _arguments, P, generator) {
...
function execCondSubQueries(builder, params, // eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
tr, trOptions, condTemplate, resolverData) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const condSubQueryResults = condSubQueries.map(x => executeCompiledQuery(builder, params, tr, trOptions, x.subQuery.query, null, null, null, resolverData).then(r => ({
      cond: x.cond,
      index: x.index,
      subQuery: x.subQuery,
      result: r
...
function mapSelectFields(ctx, x, records, isAggregation) {
  ...
  const fnScaler = (i, fieldName, field, record) => {
    ...
    record[field.aliasName] = Object(_call__WEBPACK_IMPORTED_MODULE_2__["callScalarFunction"])(ctx, field, fnInfo, 'any', record, null);
  };

  const fnImmediateScaler = (i, fieldName, field, record) => {
    const fnInfo = fnInfos[i]; // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-member-access

    record[field.aliasName] = Object(_call__WEBPACK_IMPORTED_MODULE_2__["callImmediateScalarFunction"])(ctx, field, fnInfo, 'any', record, null);
  };
...
function aggregateFields(ctx, groupBy, x, records) {
  ...
  const fnAggregate = (i, field, g, agg) => {
    ...
    agg[field.aliasName] = Object(_call__WEBPACK_IMPORTED_MODULE_2__["callAggregateFunction"])(ctx, field, fnInfo, 'any', g);
  };

  const fnImmediateScalar = (i, field, g, agg) => {
    const fnInfo = fnInfos[i]; // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-member-access

    agg[field.aliasName] = Object(_call__WEBPACK_IMPORTED_MODULE_2__["callImmediateScalarFunction"])(ctx, field, fnInfo, 'any', null, g);
  };

  const fnScalar = (i, field, g, agg) => {
    const fnInfo = fnInfos[i]; // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-member-access

    agg[field.aliasName] = Object(_call__WEBPACK_IMPORTED_MODULE_2__["callScalarFunction"])(ctx, field, fnInfo, 'any', g[0], g);
  };
...

  {
    ...
    for (const ent of x.queryFieldsMap.entries()) {
      ...
      switch (field.type) {
        case 'field':
          {
            const trueCaseName = Object(_call__WEBPACK_IMPORTED_MODULE_2__["getGroupFieldTrueCaseName"])(groupFields, field.name[field.name.length - 1]);
        ...
        case 'fncall':
          {
            ...
            switch (fnInfo === null || fnInfo === void 0 ? void 0 : fnInfo.type) {
              ...
              case 'scalar':
                if (!Object(_call__WEBPACK_IMPORTED_MODULE_2__["isScalarFnCallable"])(ctx, groupFields, field.args)) {
...
function getResolversInfo(builder, resolverNames, x, i) {
  ...
  ((_b = builder.relationships[resolverName]) !== null && _b !== void 0 ? _b : {})[// eslint-disable-next-line no-unexpected-multiline, @typescript-eslint/no-non-null-assertion
  parentResolverName] : // for detail->master relationship
  // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
  ((_c = builder.relationships[parentResolverName]) !== null && _c !== void 0 ? _c : {})[// eslint-disable-next-line no-unexpected-multiline
  resolverName]) !== null && _d !== void 0 ? _d : {}; // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
...
function normalizeLimitAndOffset(params, limit, offset) {
  var _a, _b;
  ...
  if (limit !== null && typeof limit === 'object') {
    ...
    const w = (_a = params[limit.name]) !== null && _a !== void 0 ? _a : null;
  ...
  if (offset !== null && typeof offset === 'object') {
    ...
    const w = (_b = params[offset.name]) !== null && _b !== void 0 ? _b : null;
...
function executeCompiledQuery(builder, params, // eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
tr, trOptions, query, parent, parentQueriedRecords, parentResolverNames, parentResolverData) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const {
      limit,
      offset
    } = normalizeLimitAndOffset(params, query.limit, query.offset);
    ...
    try {
      ...
      yield execCondSubQueries(builder, params, tr, trOptions, condWhereTemplate, resolverData);
      yield execCondSubQueries(builder, params, tr, trOptions, condHavingTemplate, resolverData);
      ...
      for (let i = 0; i < query.from.length; i++) {
        ...
        const condWhere = Object(_util__WEBPACK_IMPORTED_MODULE_0__["deepCloneObject"])(condWhereTemplate).map(cond => Object(_condition__WEBPACK_IMPORTED_MODULE_1__["pruneCondition"])(x.name, cond)).filter(_condition__WEBPACK_IMPORTED_MODULE_1__["filterZeroLengthCondFn"]);
        const condHaving = Object(_util__WEBPACK_IMPORTED_MODULE_0__["deepCloneObject"])(condHavingTemplate).map(cond => Object(_condition__WEBPACK_IMPORTED_MODULE_1__["pruneCondition"])(x.name, cond)).filter(_condition__WEBPACK_IMPORTED_MODULE_1__["filterZeroLengthCondFn"]);
        const ctxGen = {
          functions: builder.functions,
          query,
          params,
        ...
        if (i === 0) {
          ...
          records = yield x.resolver(resolvingFields, hasAliasNameCond ? [] : condWhere, isAggregation || hasAliasNameCond ? null : limit, isAggregation || hasAliasNameCond ? null : offset, ctx);
          ...
          if (!ctx.resolverCapabilities.filtering) {
            records = Object(_filters__WEBPACK_IMPORTED_MODULE_4__["applyWhereConditions"])(ctxGen, condWhere, records);
          }
          ...
          if (isAggregation) {
            ...
            const filteredGrouped = Object(_filters__WEBPACK_IMPORTED_MODULE_4__["applyHavingConditions"])(ctxGen, condHaving, grouped);
          ...
          for (const p of parentRecords) {
            ...
            if (!ctx.resolverCapabilities.filtering) {
              recs = Object(_filters__WEBPACK_IMPORTED_MODULE_4__["applyWhereConditions"])(ctxGen, condWhere, recs);
            }
        ...
        for (const x of query.selectSubQueries) {
          ...
          if (parentRecords) {
            ...
            if (builder.events.beforeDetailSubQueries) {
              yield builder.events.beforeDetailSubQueries(Object.assign({}, evtGen));
            }

            for (const p of parentRecords) {
              promises.push(executeCompiledQuery(builder, params, tr, trOptions, x.query, p, queriedRecords, resolverNames, resolverData).then(q => ({
                name: subQueryName,
                // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
                parent: p,
                result: q
            ...
            if (builder.events.afterDetailSubQueries) {
              yield builder.events.afterDetailSubQueries(Object.assign({}, evtGen));
            }
          }
      ...
      if (primaryRecords) {
        if (primaryCapabilities) {
          if (!primaryCapabilities.sorting) {
            primaryRecords = Object(_sort__WEBPACK_IMPORTED_MODULE_3__["sortRecords"])(query, primaryRecords);
          }
...
/*!*************************!*\
  !*** ./src/lib/util.ts ***!
  \*************************/
/*! exports provided: DatePattern, DateTimePattern, DateTimeNoTzPattern, deepCloneObject, isEqualComplexName, getFullQualifiedName, getTrueCaseFieldName, getObjectValue, getObjectValueWithFieldNameMap, getTrueCasePathName, getObjectTrueCasePathValue, getObjectPathValue, convertPattern */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "convertPattern", function() { return convertPattern; });
// Copyright (c) 2020 Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
...
/* harmony import */ var _lib_protection__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/protection */ "./src/lib/protection.ts");
/* harmony import */ var _lib_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/util */ "./src/lib/util.ts");
/* harmony import */ var _lib_csv_parser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lib/csv-parser */ "./src/lib/csv-parser.ts");
/* harmony import */ var _sort__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sort */ "./src/sort.ts");
/* harmony import */ var _filters__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./filters */ "./src/filters.ts");
// Copyright (c) 2020 Shellyl_N and Authors
// license: ISC
...
function csvRecordsParser(src) {
  const rawRecords = Object(_lib_csv_parser__WEBPACK_IMPORTED_MODULE_2__["parse"])(src.trim());
  ...
  for (let c = 0; c < header.length; c++) {
    if (Object(_lib_protection__WEBPACK_IMPORTED_MODULE_0__["isUnsafeVarNames"])(_lib_protection__WEBPACK_IMPORTED_MODULE_0__["dummyTargetObject"], header[c])) {
...
function filterAndSliceRecords(fromCache, records, fields, conditions, limit, offset, ctx, config) {
  if (!records.length) {
    // eslint-disable-next-line @typescript-eslint/no-unsafe-return
    return records;
  }
    ...
    switch (ctx.parentType) {
      case 'master':
        if (ctx.foreignIdField) {
          // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-non-null-assertion
          const parentId = Object(_lib_util__WEBPACK_IMPORTED_MODULE_1__["getObjectValue"])(ctx.parent, ctx.masterIdField); // eslint-disable-next-line @typescript-eslint/no-non-null-assertion

          const fName = Object(_lib_util__WEBPACK_IMPORTED_MODULE_1__["getTrueCaseFieldName"])(records[0], ctx.foreignIdField); // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-non-null-assertion
      ...
      case 'detail':
        if (ctx.foreignIdField) {
          // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-non-null-assertion
          const parentId = Object(_lib_util__WEBPACK_IMPORTED_MODULE_1__["getObjectValue"])(ctx.parent, ctx.foreignIdField); // eslint-disable-next-line @typescript-eslint/no-non-null-assertion

          const fName = Object(_lib_util__WEBPACK_IMPORTED_MODULE_1__["getTrueCaseFieldName"])(records[0], ctx.masterIdField); // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-non-null-assertion
  ...
  if (!config.noFiltering) {
    records = Object(_filters__WEBPACK_IMPORTED_MODULE_4__["applyWhereConditions"])(ctx, conditions, records);
    ctx.resolverCapabilities.filtering = true;
  }

  if (fromCache) {
    // eslint-disable-next-line @typescript-eslint/no-unsafe-return
    records = records.map(x => Object.assign({}, x));
  }
  ...
  if (!config.noSorting && ctx.query && ctx.query.orderBy) {
    ...
    if (ctx.graphPath.length === primaryPathLen && Object(_lib_util__WEBPACK_IMPORTED_MODULE_1__["isEqualComplexName"])(ctx.graphPath, ctx.query.from[0].name)) {
      if (ctx.query.orderBy.every(w => w.name.length === primaryPathLen + 1 && recordFields.has(w.name[w.name.length - 1].toLowerCase()))) {
        records = Object(_sort__WEBPACK_IMPORTED_MODULE_3__["sortRecords"])(ctx.query, records);
    ...
    records = records.sort((a, b) => {
      LOOP: for (let i = 0; i < fieldAndFNames.length; i++) {
        ...
        if (fName !== null) {
          ...
          fieldAndFNames[i].fName = fName = Object(_lib_util__WEBPACK_IMPORTED_MODULE_0__["getTrueCasePathName"])(b, f.name.slice(primaryPathLen)); // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
...
module.exports = __webpack_require__(/*! /home/runner/work/open-soql/open-soql/src/index.ts */"./src/index.ts");
