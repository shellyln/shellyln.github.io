...
/* harmony import */ var liyad_modules_s_exp_operators_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! liyad/modules/s-exp/operators/core */ "./node_modules/liyad/modules/s-exp/operators/core/index.js");
/* harmony import */ var liyad_modules_s_exp_interpreters__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! liyad/modules/s-exp/interpreters */ "./node_modules/liyad/modules/s-exp/interpreters/index.js");
/* harmony import */ var liyad_modules_s_exp_defaults__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! liyad/modules/s-exp/defaults */ "./node_modules/liyad/modules/s-exp/defaults.js");
/* harmony import */ var _operators__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./operators */ "./src/operators.ts");
/* harmony import */ var _lib_resolver__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./lib/resolver */ "./src/lib/resolver.ts");
/* harmony import */ var _lib_util__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./lib/util */ "./src/lib/util.ts");
// Copyright (c) 2019 Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
...
const objectValue = first(trans(tokens => [[{
  ...
  for (let i = 0; i < tokens.length; i += 2) {
    if (Object(_lib_util__WEBPACK_IMPORTED_MODULE_9__["isUnsafeVarNames"])(_lib_util__WEBPACK_IMPORTED_MODULE_9__["dummyTargetObject"], tokens[i])) {
...
const exportedDef = trans(tokens => [[{
  symbol: 'export'
}, tokens[0]]])(erase(seq('export'), qty(1)(commentOrSpace)), first(internalDef, err('exportedDef: Unexpected token has appeared.')));
...
const externalTypeDef = trans(tokens => [[{
  symbol: 'external'
}, ...tokens]])(erase(seq('external')), erase(qty(1)(commentOrSpace)), symbolName, repeat(combine(erase(repeat(commentOrSpace)), erase(cls(',')), erase(repeat(commentOrSpace)), first(symbolName, err('externalTypeDef: Unexpected token has appeared. Expect symbol name.')), erase(repeat(commentOrSpace)))), erase(repeat(commentOrSpace)), first(ahead(cls(';')), err('externalTypeDef: Unexpected token has appeared. Expect ";".')), erase(cls(';')));
...
const lisp = (() => {
  let config = Object.assign({}, liyad_modules_s_exp_defaults__WEBPACK_IMPORTED_MODULE_6__["defaultConfig"]);
  config.reservedNames = Object.assign({}, config.reservedNames, {
    Template: '$concat'
  });
  config = Object(liyad_modules_s_exp_operators_core__WEBPACK_IMPORTED_MODULE_4__["default"])(config);
  config.stripComments = true;
  return Object(liyad_modules_s_exp_interpreters__WEBPACK_IMPORTED_MODULE_5__["SExpression"])(config);
...
function compile(s) {
  ...
  const def = (name, ty) => {
    ...
    if (Object(_lib_util__WEBPACK_IMPORTED_MODULE_9__["isUnsafeVarNames"])(_lib_util__WEBPACK_IMPORTED_MODULE_9__["dummyTargetObject"], sym)) {
      throw new Error(`Unsafe symbol name is appeared: ${sym}`);
    }

    if (!mapTyToTySet.has(ret)) {
      const originalTypeName = ret.typeName;
      ret = _operators__WEBPACK_IMPORTED_MODULE_7__["withName"](_operators__WEBPACK_IMPORTED_MODULE_7__["withTypeName"](originalTypeName ? _operators__WEBPACK_IMPORTED_MODULE_7__["withOriginalTypeName"](ret, originalTypeName) : ret, sym), sym);
    }
  ...
  const ref = (name, ...memberNames) => {
    ...
    const memberTreeSymbols = memberNames.map(x => {
      ...
      if (Object(_lib_util__WEBPACK_IMPORTED_MODULE_9__["isUnsafeVarNames"])(_lib_util__WEBPACK_IMPORTED_MODULE_9__["dummyTargetObject"], ms)) {
    ...
    let ty = Object(_lib_resolver__WEBPACK_IMPORTED_MODULE_8__["resolveMemberNames"])(schema.get(sym).ty, sym, memberTreeSymbols, 0);
  ...
  const external = (...names) => {
    for (const name of names) {
      const ty = def(name, _operators__WEBPACK_IMPORTED_MODULE_7__["primitive"]('any'));
      ty.noOutput = true;
    }
  };

  lisp.setGlobals({
    picked: _operators__WEBPACK_IMPORTED_MODULE_7__["picked"],
    omit: _operators__WEBPACK_IMPORTED_MODULE_7__["omit"],
    partial: _operators__WEBPACK_IMPORTED_MODULE_7__["partial"],
    intersect: _operators__WEBPACK_IMPORTED_MODULE_7__["intersect"],
    oneOf: _operators__WEBPACK_IMPORTED_MODULE_7__["oneOf"],
    subtract: _operators__WEBPACK_IMPORTED_MODULE_7__["subtract"],
    primitive: _operators__WEBPACK_IMPORTED_MODULE_7__["primitive"],
    primitiveValue: _operators__WEBPACK_IMPORTED_MODULE_7__["primitiveValue"],
    optional: _operators__WEBPACK_IMPORTED_MODULE_7__["optional"],
    repeated: _operators__WEBPACK_IMPORTED_MODULE_7__["repeated"],
    sequenceOf: _operators__WEBPACK_IMPORTED_MODULE_7__["sequenceOf"],
    spread: _operators__WEBPACK_IMPORTED_MODULE_7__["spread"],
    enumType: _operators__WEBPACK_IMPORTED_MODULE_7__["enumType"],
    objectType: _operators__WEBPACK_IMPORTED_MODULE_7__["objectType"],
    derived: _operators__WEBPACK_IMPORTED_MODULE_7__["derived"],
    def,
    ref,
    export: ty => {
    ...
    docComment: _operators__WEBPACK_IMPORTED_MODULE_7__["withDocComment"],
    '@range': (minValue, maxValue) => ty => _operators__WEBPACK_IMPORTED_MODULE_7__["withRange"](minValue, maxValue)(ty),
    '@minValue': minValue => ty => _operators__WEBPACK_IMPORTED_MODULE_7__["withMinValue"](minValue)(ty),
    '@maxValue': maxValue => ty => _operators__WEBPACK_IMPORTED_MODULE_7__["withMaxValue"](maxValue)(ty),
    '@greaterThan': greaterThan => ty => _operators__WEBPACK_IMPORTED_MODULE_7__["withGreaterThan"](greaterThan)(ty),
    '@lessThan': lessThan => ty => _operators__WEBPACK_IMPORTED_MODULE_7__["withLessThan"](lessThan)(ty),
    '@minLength': minLength => ty => _operators__WEBPACK_IMPORTED_MODULE_7__["withMinLength"](minLength)(ty),
    '@maxLength': maxLength => ty => _operators__WEBPACK_IMPORTED_MODULE_7__["withMaxLength"](maxLength)(ty),
    '@match': pattern => ty => _operators__WEBPACK_IMPORTED_MODULE_7__["withMatch"](pattern)(ty),
    '@stereotype': stereotype => ty => _operators__WEBPACK_IMPORTED_MODULE_7__["withStereotype"](stereotype)(ty),
    '@forceCast': () => ty => _operators__WEBPACK_IMPORTED_MODULE_7__["withForceCast"]()(ty),
    '@recordType': () => ty => _operators__WEBPACK_IMPORTED_MODULE_7__["withRecordType"]()(ty),
    '@meta': meta => ty => _operators__WEBPACK_IMPORTED_MODULE_7__["withMeta"](meta)(ty),
    '@msg': messages => ty => _operators__WEBPACK_IMPORTED_MODULE_7__["withMsg"](messages)(ty),
    '@msgId': messageId => ty => _operators__WEBPACK_IMPORTED_MODULE_7__["withMsgId"](messageId)(ty)
  });
  const z = parse(s);
  lisp.evaluateAST(z);
  return Object(_lib_resolver__WEBPACK_IMPORTED_MODULE_8__["resolveSchema"])(schema);
...
/* harmony import */ var _compiler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./compiler */ "./src/compiler.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "parse", function() { return _compiler__WEBPACK_IMPORTED_MODULE_2__["parse"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "compile", function() { return _compiler__WEBPACK_IMPORTED_MODULE_2__["compile"]; });

/* harmony import */ var _operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./operators */ "./src/operators.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "picked", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["picked"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "omit", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["omit"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "partial", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["partial"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "intersect", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["intersect"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "oneOf", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["oneOf"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "subtract", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["subtract"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "primitive", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["primitive"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "regexpPatternStringType", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["regexpPatternStringType"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "primitiveValue", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["primitiveValue"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "optional", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["optional"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "repeated", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["repeated"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "sequenceOf", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["sequenceOf"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "spread", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["spread"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "enumType", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["enumType"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "objectType", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["objectType"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "derived", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["derived"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "symlinkType", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["symlinkType"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withName", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withName"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withTypeName", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withTypeName"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withOriginalTypeName", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withOriginalTypeName"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withDocComment", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withDocComment"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withRange", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withRange"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withMinValue", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withMinValue"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withMaxValue", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withMaxValue"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withGreaterThan", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withGreaterThan"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withLessThan", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withLessThan"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withMinLength", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withMinLength"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withMaxLength", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withMaxLength"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withMatch", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withMatch"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withStereotype", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withStereotype"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withForceCast", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withForceCast"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withRecordType", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withRecordType"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withMeta", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withMeta"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withMsg", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withMsg"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withMsgId", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withMsgId"]; });

/* harmony import */ var _codegen__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./codegen */ "./src/codegen.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "generateTypeScriptCode", function() { return _codegen__WEBPACK_IMPORTED_MODULE_4__["generateTypeScriptCode"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "generateJsonSchemaObject", function() { return _codegen__WEBPACK_IMPORTED_MODULE_4__["generateJsonSchemaObject"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "generateJsonSchema", function() { return _codegen__WEBPACK_IMPORTED_MODULE_4__["generateJsonSchema"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "generateProto3Code", function() { return _codegen__WEBPACK_IMPORTED_MODULE_4__["generateProto3Code"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "generateGraphQlCode", function() { return _codegen__WEBPACK_IMPORTED_MODULE_4__["generateGraphQlCode"]; });

/* harmony import */ var _serializer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./serializer */ "./src/serializer.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TynderSchemaVersion", function() { return _serializer__WEBPACK_IMPORTED_MODULE_5__["TynderSchemaVersion"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "serializeToObject", function() { return _serializer__WEBPACK_IMPORTED_MODULE_5__["serializeToObject"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "serialize", function() { return _serializer__WEBPACK_IMPORTED_MODULE_5__["serialize"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "deserializeFromObject", function() { return _serializer__WEBPACK_IMPORTED_MODULE_5__["deserializeFromObject"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "deserialize", function() { return _serializer__WEBPACK_IMPORTED_MODULE_5__["deserialize"]; });

/* harmony import */ var _validator__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./validator */ "./src/validator.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "validateRoot", function() { return _validator__WEBPACK_IMPORTED_MODULE_6__["validateRoot"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "validate", function() { return _validator__WEBPACK_IMPORTED_MODULE_6__["validate"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getType", function() { return _validator__WEBPACK_IMPORTED_MODULE_6__["getType"]; });

/* harmony import */ var _picker__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./picker */ "./src/picker.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "pickRoot", function() { return _picker__WEBPACK_IMPORTED_MODULE_7__["pickRoot"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "pick", function() { return _picker__WEBPACK_IMPORTED_MODULE_7__["pick"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "patch", function() { return _picker__WEBPACK_IMPORTED_MODULE_7__["patch"]; });
...
function generateTypeScriptCodeSequence(ty, ctx) {
  return `[${ty.sequence.filter(x => x.kind !== 'spread').map(x => x.typeName ? formatTypeName(x.typeName) : generateTypeScriptCodeInner(x, false, Object.assign(Object.assign({}, ctx), {
    nestLevel: ctx.nestLevel + 1
  }))).join(', ')}]`;
}
...
function generateTypeScriptCodeObject(ty, isInterface, ctx) {
  ...
  const sep = isInterface ? ';\n' : ';\n';
  const memberLines = ty.members.filter(x => !x[2]).map(x => `${formatTypeScriptCodeDocComment(x[3] || '', ctx.nestLevel + 1)}${'    '.repeat(ctx.nestLevel + 1)}${x[0]}${x[1].kind === 'optional' ? '?' : ''}: ${x[1].typeName ? formatTypeName(x[1].typeName) : generateTypeScriptCodeInner(x[1], false, Object.assign(Object.assign({}, ctx), {
    nestLevel: ctx.nestLevel + 1
  }))}`);
