...
const normalMapper = (data, fields) => {
  ...
  if (0 < fields.length) {
    for (const field of fields) {
      if (Object(_lib_protection__WEBPACK_IMPORTED_MODULE_0__["isUnsafeVarNames"])(_lib_protection__WEBPACK_IMPORTED_MODULE_0__["dummyTargetObject"], field)) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "withConstraint", function() { return _operators__WEBPACK_IMPORTED_MODULE_3__["withConstraint"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "validateRoot", function() { return _validator__WEBPACK_IMPORTED_MODULE_4__["validateRoot"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "validate", function() { return _validator__WEBPACK_IMPORTED_MODULE_4__["validate"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "isType", function() { return _validator__WEBPACK_IMPORTED_MODULE_4__["isType"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "assertType", function() { return _validator__WEBPACK_IMPORTED_MODULE_4__["assertType"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getType", function() { return _validator__WEBPACK_IMPORTED_MODULE_4__["getType"]; });

/* harmony import */ var _picker__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./picker */ "./src/picker.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "pickRoot", function() { return _picker__WEBPACK_IMPORTED_MODULE_5__["pickRoot"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "pick", function() { return _picker__WEBPACK_IMPORTED_MODULE_5__["pick"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "patch", function() { return _picker__WEBPACK_IMPORTED_MODULE_5__["patch"]; });
...
/*!*************************!*\
  !*** ./src/lib/util.ts ***!
  \*************************/
/*! exports provided: SymbolPattern, NumberPattern, DatePattern, DateTimePattern, DateTimeNoTzPattern, nvl, nvl2 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function enumType(...values) {
  ...
  for (let i = 0; i < ar.length; i++) {
    if (Object(_lib_protection__WEBPACK_IMPORTED_MODULE_0__["isUnsafeVarNames"])(_lib_protection__WEBPACK_IMPORTED_MODULE_0__["dummyTargetObject"], ar[i][0])) {
...
function objectType(...members) {
  ...
  for (const x of members) {
    if (typeof x[0] === 'string') {
      if (Object(_lib_protection__WEBPACK_IMPORTED_MODULE_0__["isUnsafeVarNames"])(_lib_protection__WEBPACK_IMPORTED_MODULE_0__["dummyTargetObject"], x[0])) {
...
function withStereotype(stereotype) {
  ...
  if (Object(_lib_protection__WEBPACK_IMPORTED_MODULE_0__["isUnsafeVarNames"])(_lib_protection__WEBPACK_IMPORTED_MODULE_0__["dummyTargetObject"], stereotype)) {
...
function withConstraint(name, args) {
  ...
  if (Object(_lib_protection__WEBPACK_IMPORTED_MODULE_0__["isUnsafeVarNames"])(_lib_protection__WEBPACK_IMPORTED_MODULE_0__["dummyTargetObject"], name)) {
...
/* harmony import */ var _lib_protection__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/protection */ "./src/lib/protection.ts");
      ...
      if (Array.isArray(data)) {
        ...
        for (const k in needle) {
          if (Object.prototype.hasOwnProperty.call(needle, k)) {
            if (Object(_lib_protection__WEBPACK_IMPORTED_MODULE_1__["isUnsafeVarNames"])(r, k)) {
              continue;
            }
...
/* harmony import */ var _lib_protection__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lib/protection */ "./src/lib/protection.ts");
/* harmony import */ var _lib_reporter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./lib/reporter */ "./src/lib/reporter.ts");
/* harmony import */ var _lib_resolver__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lib/resolver */ "./src/lib/resolver.ts");
/* harmony import */ var _stereotypes_noop__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./stereotypes/noop */ "./src/stereotypes/noop.ts");
// Copyright (c) 2019 Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
...
function validateNeverTypeAssertion(data, ty, ctx) {
  Object(_lib_reporter__WEBPACK_IMPORTED_MODULE_4__["reportError"])(_types__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].TypeUnmatched, data, ty, {
    ctx
  });
  return null;
}
...
function validateAnyTypeAssertion(data, ty, ctx) {
  ...
  if (chkSt === null) {
    ...
    chkSt = {
      value: data,
      stereotype: _stereotypes_noop__WEBPACK_IMPORTED_MODULE_6__["noopStereotype"]
    };
  }
  ...
  if (checkCustomConstraints(data, ty, ctx) === null) {
    Object(_lib_reporter__WEBPACK_IMPORTED_MODULE_4__["reportError"])(_types__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].ValueUnmatched, data, ty, {
      ctx
    });
    return null;
  } // always matched
...
function validatePrimitiveTypeAssertion(data, ty, ctx) {
  ...
  if (chkSt === null) {
    ...
    chkSt = {
      value: chkTarget,
      stereotype: ty.forceCast ? _stereotypes_noop__WEBPACK_IMPORTED_MODULE_6__["noopStereotype"] : _stereotypes_noop__WEBPACK_IMPORTED_MODULE_6__["noopStereotype"]
    };
  }
  ...
  switch (typeof ty.minValue) {
    ...
    case 'string':
      ...
      if (styp.compare(styVal, styp.evaluateFormula(ty.minValue)) < 0) {
        if (!valueRangeErr) {
          Object(_lib_reporter__WEBPACK_IMPORTED_MODULE_4__["reportError"])(_types__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].ValueRangeUnmatched, data, ty, {
            ctx
          });
        }
  ...
  switch (typeof ty.minLength) {
    case 'number':
      if (typeof styVal !== 'string' || styVal.length < ty.minLength) {
        if (!valueLengthErr) {
          Object(_lib_reporter__WEBPACK_IMPORTED_MODULE_4__["reportError"])(_types__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].ValueLengthUnmatched, data, ty, {
            ctx
          });
        }
  ...
  if (ty.pattern) {
    if (typeof styVal !== 'string' || !ty.pattern.test(styVal)) {
      Object(_lib_reporter__WEBPACK_IMPORTED_MODULE_4__["reportError"])(_types__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].ValuePatternUnmatched, data, ty, {
        ctx
      });
      err = true;
    }
...
function validateRepeatedAssertion(data, ty, ctx) {
  ...
  if (typeof ty.min === 'number' && data.length < ty.min) {
    Object(_lib_reporter__WEBPACK_IMPORTED_MODULE_4__["reportError"])(_types__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].RepeatQtyUnmatched, data, ty, {
      ctx
    });
    return null;
  }
...
function validateSequenceAssertion(data, ty, ctx) {
  ...
  const checkSpreadQuantity = (ts, index) => {
    if (typeof ts.min === 'number' && spreadLen < ts.min) {
      Object(_lib_reporter__WEBPACK_IMPORTED_MODULE_4__["reportErrorWithPush"])(spreadLen === 0 ? _types__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].TypeUnmatched : _types__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].RepeatQtyUnmatched, data, [ts, index], {
        ctx
      });
      return null;
    }
    ...
    if (typeof ts.max === 'number' && spreadLen > ts.max) {
      Object(_lib_reporter__WEBPACK_IMPORTED_MODULE_4__["reportErrorWithPush"])(_types__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].RepeatQtyUnmatched, data, [ts, index], {
        ctx
      });
      return null;
    }
  ...
  while (sIdx < ty.sequence.length) {
    ...
    if (ts.kind === 'spread') {
      ...
      Object(_lib_reporter__WEBPACK_IMPORTED_MODULE_4__["reportErrorWithPush"])(_types__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].RepeatQtyUnmatched, data, [ts, dIdx], {
        ctx
      });
      return null;
    }
  ...
  if (!ret) {
    Object(_lib_reporter__WEBPACK_IMPORTED_MODULE_4__["reportError"])(_types__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].SequenceUnmatched, data, ty, {
      ctx
    });
  }
...
function validateObjectAssertion(data, ty, ctx) {
  ...
  for (const x of ty.members) {
    if (ty.members.find(m => m[0] === x[0]) !== revMembers.find(m => m[0] === x[0])) {
      Object(_lib_reporter__WEBPACK_IMPORTED_MODULE_4__["reportError"])(_types__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].InvalidDefinition, data, ty, {
        ctx
      });
  ...
  if (data === null || typeof data !== 'object') {
    ...
    if (ctx.noAdditionalProps && Array.isArray(data) && 0 < data.length) {
      ...
      if (aps.filter(x => x[0].includes('number')).length === 0) {
        Object(_lib_reporter__WEBPACK_IMPORTED_MODULE_4__["reportError"])(_types__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].AdditionalPropUnmatched, data, ty, {
          ctx,
    ...
    for (const x of ty.members) {
      ...
      if (Object.prototype.hasOwnProperty.call(data, x[0])) {
        ...
        if (ret) {
          if (retVal) {
            if (Object(_lib_protection__WEBPACK_IMPORTED_MODULE_3__["isUnsafeVarNames"])(retVal, x[0])) {
              continue;
            }
        ...
        if (x[1].kind !== 'optional') {
          Object(_lib_reporter__WEBPACK_IMPORTED_MODULE_4__["reportErrorWithPush"])(_types__WEBPACK_IMPORTED_MODULE_0__["ErrorTypes"].Required, data, [x[1], void 0], {
            ctx
          });
        ...
        for (const at of matchedAssertions) {
          ...
          if (ret) {
            if (retVal) {
              ...
              if (Object(_lib_protection__WEBPACK_IMPORTED_MODULE_3__["isUnsafeVarNames"])(retVal, m)) {
                continue;
              }
...
function validateRoot(data, ty, ctx, dataIndex) {
  try {
    ...
    switch (ty.kind) {
      ...
      case 'symlink':
        if (ctx.schema) {
          return validateRoot(data, Object(_lib_resolver__WEBPACK_IMPORTED_MODULE_5__["resolveSymbols"])(ctx.schema, ty, {
            nestLevel: 0,
            symlinkStack: []
          }), ctx);
        }
...
module.exports = __webpack_require__(/*! /home/runner/work/tynder/tynder/src/index-rt.ts */"./src/index-rt.ts");
