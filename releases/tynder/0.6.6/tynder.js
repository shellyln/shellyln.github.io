...
/* harmony import */ var _global_this__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./global-this */ "./node_modules/liyad/modules/s-exp/global-this.js");
// Copyright (c) 2018, Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
...
/***/ "./node_modules/liyad/modules/s-exp/global-this.js":
/*!*********************************************************!*\
  !*** ./node_modules/liyad/modules/s-exp/global-this.js ***!
  \*********************************************************/
...
/* harmony import */ var _lib_protection__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./lib/protection */ "./src/lib/protection.ts");
...
function compile(s) {
  ...
  const def = (name, ty) => {
    ...
    if (Object(_lib_protection__WEBPACK_IMPORTED_MODULE_7__["isUnsafeVarNames"])(_lib_protection__WEBPACK_IMPORTED_MODULE_7__["dummyTargetObject"], sym)) {
  ...
  const ref = (name, ...memberNames) => {
    ...
    const memberTreeSymbols = memberNames.map(x => {
      ...
      if (Object(_lib_protection__WEBPACK_IMPORTED_MODULE_7__["isUnsafeVarNames"])(_lib_protection__WEBPACK_IMPORTED_MODULE_7__["dummyTargetObject"], ms)) {
...
/* harmony import */ var _protection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./protection */ "./src/lib/protection.ts");
// Copyright (c) 2019 Shellyl_N and Authors
// license: ISC
// https://github.com/shellyln
...
const signleQuotStringValue = trans(tokens => {
  var _a;
...
const doubleQuotStringValue = trans(tokens => {
  var _a;

  return [(_a = tokens[0]) !== null && _a !== void 0 ? _a : ''];
})(erase(seq('"')), cat(repeat(first(stringEscapeSeq, combine(cls('\r', '\n'), err('Line breaks within strings are not allowed.')), notCls('"')))), erase(seq('"')));
const backQuotStringValue = trans(tokens => {
  var _a;

  return [(_a = tokens[0]) !== null && _a !== void 0 ? _a : ''];
})(erase(seq('`')), cat(repeat(first(stringEscapeSeq, notCls('`')))), erase(seq('`')));
...
trans(tokens => {
  ...
  return [{
    value: tokens[1] ? new RegExp((_a = tokens[0]) !== null && _a !== void 0 ? _a : '', tokens[1]) : new RegExp((_b = tokens[0]) !== null && _b !== void 0 ? _b : '')
  }];
...
const objectValue = first(trans(tokens => [[{
  ...
  for (let i = 0; i < tokens.length; i += 2) {
    if (Object(_protection__WEBPACK_IMPORTED_MODULE_2__["isUnsafeVarNames"])(_protection__WEBPACK_IMPORTED_MODULE_2__["dummyTargetObject"], tokens[i])) {
...
module.exports = __webpack_require__(/*! /home/runner/work/tynder/tynder/src/index.ts */"./src/index.ts");
